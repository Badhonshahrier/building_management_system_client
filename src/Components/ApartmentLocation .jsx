        ...
        <div className="p-6 rounded-xl">
          ...
          <ul className="space-y-4 flex flex-col items-center text-gray-700 text-base">
            <li className="flex gap-3 items-start w-full max-w-xl">
              ...
              <span>
                <strong>Bus Route:</strong> Get off at Dhanmondi 27 or Shimanto Square Bus Stop.
              </span>
            </li>
            <li className="flex gap-3 items-start w-full max-w-xl">
              <FaCar className="text-blue-500 mt-1" />
              <span>
                <strong>Ride Sharing:</strong> Uber, Pathao, CNG are available. Just search “House 15, Road 27”.
              </span>
            </li>
            <li className="flex gap-3 items-start w-full max-w-xl">
              <FaHospital className="text-red-500 mt-1" />
              <span>
                <strong>Landmarks:</strong> Near Labaid Hospital, opposite Dhanmondi Lake.
              </span>
            </li>
            <li className="flex gap-3 items-start w-full max-w-xl">
              <FaMapMarkerAlt className="text-pink-600 mt-1" />
              <span>
                <strong>Address:</strong> House-15, Road-27, Dhanmondi, Dhaka 1209
              </span>
            </li>
            <li className="flex gap-3 items-start w-full max-w-xl">
